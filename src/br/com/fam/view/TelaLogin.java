...
public class TelaLogin {
	...
	private JButton btnCadastrar, btnSair, btnAcessar;
	...
	private void iniciarComponentes() {
		...
		btnAcessar.setLocation(80, 90);
		btnAcessar.setSize(250, 30);
		...
		btnAcessar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (txtSenha.getText().isEmpty() && txtLogin.getText().isEmpty()) {
					...
					if (txtLogin.getText().equals("admin") && txtSenha.getText().equals("0000")) {
						frmTela.dispose();
						new TelaInicial();
					} else {
